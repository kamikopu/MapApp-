...
class App {
  ...
  //   if (turnNumberBoolean) return;
  //   if (e.target.classList.contains('del') && !intervalTimeLongPress) {
  //     // 结合之后在这里添加每次触发时的全部del的dom的捕获

  //     startWithPressDelButton = true;
  //     intervalTimeLongPress = setInterval(function () {
  //       console.log(1);
  //     }, 100);

  //     timeoutLongPress = setTimeout(function () {
  //       console.log('oky'); //结合时在这个位置添加结合代码
  //       turnNumberBoolean = true;
  //       clearInterval(intervalTimeLongPress);
  //       intervalTimeLongPress = undefined;
  //       timeoutLongPress = undefined;
  //     }, 2000);
  //   }
  //   // });
  // }
...
//当按键升起时 重置time计时器并设置time变量为undefined 和设置turnNumberBoolean即判断是否重复触发的布尔值
// window.addEventListener('mouseup', function (e) {
//   e.preventDefault();
//   // if (e.target.classList.contains('del')) {
//   if (!startWithPressDelButton) return;
//   console.log(2);
//   if (timeoutLongPress) {
//     clearTimeout(timeoutLongPress);
//     timeoutLongPress = undefined;
//   }
//   if (intervalTimeLongPress) {
//     clearInterval(intervalTimeLongPress);
//     intervalTimeLongPress = undefined;
//   }
//   //在每次按键释放后都把判断变量重置
//   startWithPressDelButton = false;
//   turnNumberBoolean = false;
//   console.log(startWithPressDelButton);
//   // }
// });
